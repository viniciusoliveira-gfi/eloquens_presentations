export type Lang = "en" | "it" | "de" | "pt" | "cs";
...
const translations = {
  // ─── HeroSlide ───
  hero: {
    inbox: { en: "Your Inbox.", it: "La Tua Inbox.", de: "Dein Posteingang.", pt: "Sua Caixa de Entrada.", cs: "Vaše schránka." },
    handled: { en: "Handled.", it: "Gestita.", de: "Erledigt.", pt: "Resolvida.", cs: "Vyřízena." },
    subtitle: {
    ...
    responseTime: { en: "Response Time", it: "Tempo di Risposta", de: "Antwortzeit", pt: "Tempo de Resposta", cs: "Doba odezvy" },
    languages: { en: "Languages", it: "Lingue", de: "Sprachen", pt: "Idiomas", cs: "Jazyků" },
    alwaysOn: { en: "Always On", it: "Sempre Attivo", de: "Immer Aktiv", pt: "Sempre Ativo", cs: "Vždy aktivní" },
    cta: { en: "See How It Works", it: "Scopri Come Funziona", de: "So funktioniert es", pt: "Veja Como Funciona", cs: "Jak to funguje" },
  },

  // ─── EmailMattersSlide ───
  emailMatters: {
    tag: { en: "The Paradox", it: "Il Paradosso", de: "Das Paradoxon", pt: "O Paradoxo", cs: "Paradox" },
    titleStart: {
    ...
    titleHighlight: { en: "Email", it: "Email", de: "E-Mail", pt: "E-mail", cs: "E-mail" },
    importantChannel: {
  ...
  // ─── OldPlaybookSlide ───
  oldPlaybook: {
    tag: { en: "The Reality", it: "La Realtà", de: "Die Realität", pt: "A Realidade", cs: "Realita" },
    titleStart: {
    ...
    titleHighlight: { en: "Less.", it: "Meno.", de: "Weniger.", pt: "Menos.", cs: "Méně." },
    customersExpect: { en: "Customers Expect", it: "I Clienti Si Aspettano", de: "Kunden erwarten", pt: "Clientes Esperam", cs: "Zákazníci očekávají" },
    customersExpectDesc: {
    ...
    businessesDeliver: { en: "Businesses Deliver", it: "Le Aziende Offrono", de: "Unternehmen liefern", pt: "Empresas Entregam", cs: "Firmy dodávají" },
    ...
    theResult: { en: "The Result", it: "Il Risultato", de: "Das Ergebnis", pt: "O Resultado", cs: "Výsledek" },
    theResultDesc: {
    ...
    teamsMaxed: { en: "Teams Are Maxed Out", it: "I Team Sono al Limite", de: "Teams sind am Limit", pt: "Equipes Estão no Limite", cs: "Týmy jsou na limitu" },
    teamsMaxedDesc: {
    ...
    cantHire: { en: "Can't Hire Your Way Out", it: "Assumere Non Basta", de: "Einstellen reicht nicht", pt: "Contratar Não Resolve", cs: "Najímáním to nevyřešíte" },
    cantHireDesc: {
  ...
  // ─── ThreeLevelsSlide ───
  threeLevels: {
    tag: { en: "AI is the Answer, but", it: "L'IA è la Risposta, ma", de: "KI ist die Antwort, aber", pt: "IA é a Resposta, mas", cs: "AI je odpověď, ale" },
    titleStart: { en: "Draft-Only AI Is", it: "L'IA Solo-Bozza", de: "Nur-Entwurf-KI ist", pt: "IA Só de Rascunho", cs: "AI jen na koncepty" },
    titleHighlight: { en: "Not Enough.", it: "Non Basta.", de: "Nicht Genug.", pt: "Não Basta.", cs: "Nestačí." },
    level1Title: { en: "Templated Auto-Replies", it: "Risposte Automatiche Template", de: "Vorlagen-Autoantworten", pt: "Respostas Automáticas por Template", cs: "Šablonové automatické odpovědi" },
    level1Desc: {
    ...
    level2Title: { en: "AI Draft Generation", it: "Generazione Bozze IA", de: "KI-Entwurfserstellung", pt: "Geração de Rascunhos por IA", cs: "AI generování konceptů" },
    level2Desc: {
    ...
    level3Title: { en: "Autonomous Email Agents", it: "Agenti Email Autonomi", de: "Autonome E-Mail-Agenten", pt: "Agentes de E-mail Autônomos", cs: "Autonomní e-mailoví agenti" },
    level3Desc: {
    ...
    level: { en: "Level", it: "Livello", de: "Stufe", pt: "Nível", cs: "Úroveň" },
    hint: { en: "Click each level to explore", it: "Clicca ogni livello per esplorare", de: "Klicken Sie auf jede Stufe", pt: "Clique em cada nível para explorar", cs: "Klikněte na každou úroveň" },
  },

  // ─── SolutionSlide ───
  solution: {
    tag: { en: "The Solution", it: "La Soluzione", de: "Die Lösung", pt: "A Solução", cs: "Řešení" },
    titleStart: { en: "Meet", it: "Scopri", de: "Lernen Sie kennen:", pt: "Conheça", cs: "Představujeme" },
    subtitle: {
    ...
    cap1Title: { en: "Reads & Understands", it: "Legge e Comprende", de: "Liest & Versteht", pt: "Lê e Compreende", cs: "Čte a rozumí" },
    cap1Desc: {
    ...
    cap2Title: { en: "Thinks & Decides", it: "Pensa e Decide", de: "Denkt & Entscheidet", pt: "Pensa e Decide", cs: "Myslí a rozhoduje" },
    cap2Desc: {
    ...
    cap3Title: { en: "Writes in Your Voice", it: "Scrive con la Tua Voce", de: "Schreibt in Ihrer Stimme", pt: "Escreve com Sua Voz", cs: "Píše vaším hlasem" },
    cap3Desc: {
    ...
    cap4Title: { en: "Learns & Improves", it: "Impara e Migliora", de: "Lernt & Verbessert sich", pt: "Aprende e Melhora", cs: "Učí se a zlepšuje" },
    cap4Desc: {
  ...
  // ─── TrustSlide ───
  trust: {
    tag: { en: "Eloquens\u00ae AI is Built for", it: "Eloquens\u00ae AI è Costruita per la", de: "Eloquens\u00ae AI ist gebaut für", pt: "Eloquens\u00ae AI foi Feita para", cs: "Eloquens\u00ae AI je navržena pro" },
    titleStart: { en: "End-to-End", it: "Risoluzione", de: "End-to-End-", pt: "Resolução", cs: "Kompletní" },
    titleHighlight: { en: "Resolution.", it: "End-to-End.", de: "Lösung.", pt: "de Ponta a Ponta.", cs: "Řešení." },
    pillar1Title: { en: "Full Control", it: "Controllo Totale", de: "Volle Kontrolle", pt: "Controle Total", cs: "Plná kontrola" },
    pillar1Desc: {
    ...
    pillar1Highlight: { en: "You choose the automation level", it: "Tu scegli il livello di automazione", de: "Sie wählen den Automatisierungsgrad", pt: "Você escolhe o nível de automação", cs: "Úroveň automatizace volíte vy" },
    pillar2Title: { en: "No Hallucinations. Ever.", it: "Nessuna Allucinazione. Mai.", de: "Keine Halluzinationen. Nie.", pt: "Sem Alucinações. Nunca.", cs: "Žádné halucinace. Nikdy." },
    pillar2Desc: {
    ...
    pillar2Highlight: { en: "Only real, verified data", it: "Solo dati reali e verificati", de: "Nur echte, verifizierte Daten", pt: "Apenas dados reais e verificados", cs: "Pouze reálná, ověřená data" },
    pillar3Title: { en: "Human-in-the-Loop", it: "Human-in-the-Loop", de: "Human-in-the-Loop", pt: "Human-in-the-Loop", cs: "Human-in-the-Loop" },
    pillar3Desc: {
    ...
    pillar3Highlight: { en: "Self-learning, always improving", it: "Auto-apprendimento, sempre in miglioramento", de: "Selbstlernend, stetige Verbesserung", pt: "Autoaprendizado, sempre melhorando", cs: "Samoučící se, neustále se zlepšuje" },
    bottomBold: {
    ...
    bottomHighlight: { en: "it sends.", it: "invia.", de: "es sendet.", pt: "envia.", cs: "odesílá." },
    bottomDesc: {
  ...
  // ─── VoiceSlide ───
  voice: {
    tag: { en: "Voice Matching", it: "Matching Vocale", de: "Stimmen-Matching", pt: "Correspondência de Voz", cs: "Sladění hlasu" },
    titleStart: { en: "It Sounds Like You.", it: "Sembra Proprio Te.", de: "Es klingt wie Sie.", pt: "Parece Você.", cs: "Zní to jako vy." },
    titleHighlight: { en: "Because You Trained It.", it: "Perché l'Hai Addestrata.", de: "Weil Sie es trainiert haben.", pt: "Porque Você a Treinou.", cs: "Protože jste ji natrénovali." },
    subtitle: {
    ...
    supportLabel: { en: "Customer Support", it: "Supporto Clienti", de: "Kundensupport", pt: "Suporte ao Cliente", cs: "Zákaznická podpora" },
    supportTone: {
    ...
    salesLabel: { en: "Sales", it: "Vendite", de: "Vertrieb", pt: "Vendas", cs: "Obchod" },
    salesTone: {
    ...
    assistantLabel: { en: "Personal Assistant", it: "Assistente Personale", de: "Persönlicher Assistent", pt: "Assistente Pessoal", cs: "Osobní asistent" },
    assistantTone: {
    ...
    legalLabel: { en: "Legal", it: "Legale", de: "Recht", pt: "Jurídico", cs: "Právo" },
    legalTone: {
    ...
    bottomStart: { en: "Not generic AI filler.", it: "Non è filler generico di IA.", de: "Kein generischer KI-Fülltext.", pt: "Não é preenchimento genérico de IA.", cs: "Žádný generický AI výplň." },
    bottomBold: {
    ...
    tone: { en: "Tone", it: "Tono", de: "Ton", pt: "Tom", cs: "Tón" },
  },

  // ─── HowItWorksSlide ───
  howItWorks: {
    tag: { en: "Getting Started", it: "Per Iniziare", de: "Erste Schritte", pt: "Como Começar", cs: "Začínáme" },
    titleStart: { en: "How It", it: "Come", de: "So", pt: "Como", cs: "Jak to" },
    titleHighlight: { en: "Works", it: "Funziona", de: "funktioniert es", pt: "Funciona", cs: "Funguje" },
    subtitle: {
    ...
    step1Title: { en: "Connect Your Inbox", it: "Collega la Tua Inbox", de: "Verbinden Sie Ihren Posteingang", pt: "Conecte Sua Caixa de Entrada", cs: "Připojte schránku" },
    step1Desc: {
    ...
    step2Title: { en: "Set Rules & Tone", it: "Imposta Regole e Tono", de: "Regeln & Ton festlegen", pt: "Defina Regras e Tom", cs: "Nastavte pravidla a tón" },
    step2Desc: {
    ...
    step3Title: { en: "Add Your Knowledge", it: "Aggiungi la Tua Conoscenza", de: "Fügen Sie Ihr Wissen hinzu", pt: "Adicione Seu Conhecimento", cs: "Přidejte své znalosti" },
    step3Desc: {
    ...
    step4Title: { en: "Let Eloquens\u00ae AI Run", it: "Lascia Correre Eloquens\u00ae AI", de: "Lassen Sie Eloquens\u00ae AI laufen", pt: "Deixe Eloquens\u00ae AI Rodar", cs: "Nechte Eloquens\u00ae AI běžet" },
    step4Desc: {
    ...
    connectCta: { en: "Connect Your Inbox \u2192", it: "Collega la Tua Inbox \u2192", de: "Posteingang verbinden \u2192", pt: "Conecte Sua Caixa de Entrada \u2192", cs: "Připojit schránku \u2192" },
  },

  // ─── ProcessSlide ───
  process: {
    tag: { en: "Inside the Engine", it: "Dentro il Motore", de: "Im Inneren der Engine", pt: "Dentro do Motor", cs: "Uvnitř enginu" },
    titleStart: { en: "How Eloquens\u00ae AI", it: "Come Eloquens\u00ae AI", de: "Wie Eloquens\u00ae AI", pt: "Como Eloquens\u00ae AI", cs: "Jak Eloquens\u00ae AI" },
    titleHighlight: { en: "Thinks & Decides", it: "Pensa e Decide", de: "Denkt & Entscheidet", pt: "Pensa e Decide", cs: "Myslí a rozhoduje" },
    step1: { en: "Email Received", it: "Email Ricevuta", de: "E-Mail empfangen", pt: "E-mail Recebido", cs: "E-mail přijat" },
    step2: { en: "Smart Filters", it: "Filtri Intelligenti", de: "Intelligente Filter", pt: "Filtros Inteligentes", cs: "Chytré filtry" },
    step3: { en: "Knowledge Base", it: "Base di Conoscenza", de: "Wissensdatenbank", pt: "Base de Conhecimento", cs: "Znalostní báze" },
    step4: { en: "Routing", it: "Routing", de: "Routing", pt: "Roteamento", cs: "Směrování" },
    step5: { en: "Response", it: "Risposta", de: "Antwort", pt: "Resposta", cs: "Odpověď" },
    previous: { en: "Previous", it: "Precedente", de: "Zurück", pt: "Anterior", cs: "Zpět" },
    nextStep: { en: "Next Step", it: "Prossimo", de: "Nächster Schritt", pt: "Próximo", cs: "Další krok" },
    emailAnalysis: { en: "Email Analysis", it: "Analisi Email", de: "E-Mail-Analyse", pt: "Análise de E-mail", cs: "Analýza e-mailu" },
    approvedForResponse: { en: "Approved for Response", it: "Approvata per Risposta", de: "Für Antwort genehmigt", pt: "Aprovado para Resposta", cs: "Schváleno k odpovědi" },
    intent: { en: "Intent", it: "Intento", de: "Absicht", pt: "Intenção", cs: "Záměr" },
    followUpScheduling: { en: "Follow-up / Scheduling", it: "Follow-up / Pianificazione", de: "Follow-up / Terminplanung", pt: "Follow-up / Agendamento", cs: "Follow-up / Plánování" },
    urgency: { en: "Urgency", it: "Urgenza", de: "Dringlichkeit", pt: "Urgência", cs: "Naléhavost" },
    medium: { en: "Medium", it: "Media", de: "Mittel", pt: "Média", cs: "Střední" },
    sentiment: { en: "Sentiment", it: "Sentimento", de: "Stimmung", pt: "Sentimento", cs: "Sentiment" },
    positive: { en: "Positive", it: "Positivo", de: "Positiv", pt: "Positivo", cs: "Pozitivní" },
    analysisQuote: {
    ...
    knowledgeSearch: { en: "Knowledge Search", it: "Ricerca Conoscenza", de: "Wissenssuche", pt: "Busca de Conhecimento", cs: "Hledání ve znalostech" },
    sourcesSearched: { en: "Sources Searched", it: "Fonti Ricercate", de: "Quellen durchsucht", pt: "Fontes Pesquisadas", cs: "Prohledané zdroje" },
    matchesFound: { en: "Matches Found", it: "Corrispondenze", de: "Treffer gefunden", pt: "Correspondências", cs: "Nalezené shody" },
    topMatches: { en: "Top Matches", it: "Migliori Risultati", de: "Beste Treffer", pt: "Melhores Resultados", cs: "Nejlepší shody" },
    routingDecision: { en: "Routing Decision", it: "Decisione di Routing", de: "Routing-Entscheidung", pt: "Decisão de Roteamento", cs: "Rozhodnutí o směrování" },
    escalate: { en: "Escalate", it: "Escala", de: "Eskalieren", pt: "Escalar", cs: "Eskalovat" },
    handover: { en: "Handover", it: "Passaggio", de: "Übergabe", pt: "Transferência", cs: "Předání" },
    reply: { en: "Reply", it: "Rispondi", de: "Antworten", pt: "Responder", cs: "Odpovědět" },
    confidence: { en: "Confidence", it: "Fiducia", de: "Konfidenz", pt: "Confiança", cs: "Spolehlivost" },
    draftReply: { en: "Draft Reply", it: "Bozza Risposta", de: "Antwortentwurf", pt: "Rascunho de Resposta", cs: "Koncept odpovědi" },
    toneLabel: { en: "Tone: Professional \u00b7 Warm", it: "Tono: Professionale \u00b7 Caloroso", de: "Ton: Professionell \u00b7 Warm", pt: "Tom: Profissional \u00b7 Caloroso", cs: "Tón: Profesionální \u00b7 Vřelý" },
    send: { en: "Send", it: "Invia", de: "Senden", pt: "Enviar", cs: "Odeslat" },
    to: { en: "To:", it: "A:", de: "An:", pt: "Para:", cs: "Komu:" },
    subject: { en: "Subject:", it: "Oggetto:", de: "Betreff:", pt: "Assunto:", cs: "Předmět:" },
    received: { en: "Received 2 min ago", it: "Ricevuta 2 min fa", de: "Vor 2 Min. empfangen", pt: "Recebido há 2 min", cs: "Přijato před 2 min" },
    newBadge: { en: "New", it: "Nuova", de: "Neu", pt: "Novo", cs: "Nový" },
  },

  // ─── ProofSlide ───
  proof: {
    tag: { en: "Trust & Results", it: "Fiducia e Risultati", de: "Vertrauen & Ergebnisse", pt: "Confiança e Resultados", cs: "Důvěra a výsledky" },
    titleStart: { en: "Trusted by Teams.", it: "Affidabile per i Team.", de: "Von Teams vertraut.", pt: "Confiável para Equipes.", cs: "Důvěřují nám týmy." },
    titleHighlight: { en: "Secured by Design.", it: "Sicura by Design.", de: "Sicher by Design.", pt: "Segura por Design.", cs: "Zabezpečeno designem." },
    casaVerified: { en: "CASA Verified", it: "Verificato CASA", de: "CASA-verifiziert", pt: "Verificado CASA", cs: "CASA ověřeno" },
    dataResidency: { en: "EU & US Data Residency", it: "Residenza Dati EU & US", de: "EU & US Datenresidenz", pt: "Residência de Dados EU & US", cs: "Rezidence dat EU & US" },
    compliance: { en: "GDPR \u00b7 CCPA \u00b7 HIPAA", it: "GDPR \u00b7 CCPA \u00b7 HIPAA", de: "DSGVO \u00b7 CCPA \u00b7 HIPAA", pt: "LGPD \u00b7 CCPA \u00b7 HIPAA", cs: "GDPR \u00b7 CCPA \u00b7 HIPAA" },
    fasterResponse: { en: "Faster Response", it: "Risposta Più Veloce", de: "Schnellere Antwort", pt: "Resposta Mais Rápida", cs: "Rychlejší odpověď" },
    fasterResponseDesc: {
    ...
    timeFreed: { en: "Time Freed", it: "Tempo Liberato", de: "Zeit gespart", pt: "Tempo Liberado", cs: "Ušetřený čas" },
    timeFreedDesc: {
  ...
  // ─── CTASlide ───
  cta: {
    title: { en: "Email, Finally", it: "Email, Finalmente", de: "E-Mail, Endlich", pt: "E-mail, Finalmente", cs: "E-mail, konečně" },
    titleHighlight: { en: "Handled.", it: "Gestita.", de: "Erledigt.", pt: "Resolvida.", cs: "Vyřízený." },
    subtitle: {
    ...
    getStarted: { en: "Get Started Free", it: "Inizia Gratis", de: "Kostenlos starten", pt: "Comece Grátis", cs: "Začněte zdarma" },
    bookDemo: { en: "Book a Demo", it: "Prenota una Demo", de: "Demo buchen", pt: "Agende uma Demo", cs: "Domluvte demo" },
    tagline: { en: "Your Inbox. Handled.", it: "La Tua Inbox. Gestita.", de: "Ihr Posteingang. Erledigt.", pt: "Sua Caixa de Entrada. Resolvida.", cs: "Vaše schránka. Vyřízena." },
  },
} as const;
