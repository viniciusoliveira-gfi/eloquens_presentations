        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          {pillars.map((pillar, i) => (
            <div key={i} className="clean-card p-4 md:p-8 text-center">
              <div className="icon-box !w-10 !h-10 md:!w-14 md:!h-14 !rounded-xl md:!rounded-2xl mx-auto mb-3 md:mb-5">
                <pillar.icon size={20} className="text-brand-accent md:hidden" />
                <pillar.icon size={24} className="text-brand-accent hidden md:block" />
              </div>
              <h3 className="text-base md:text-xl font-bold text-brand-dark mb-2 md:mb-3">
                {pillar.title}
              </h3>
