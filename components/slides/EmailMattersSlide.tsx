    ...
    <SlideWrapper isActive={isActive} variant="soft">
      <div className="w-full">
            ...
            <div className="space-y-2 md:space-y-4">
              {[
                ...
                <div key={i} className="flex items-center gap-2 md:gap-3">
                  ...
                  <p className="text-brand-slate text-xs md:text-sm leading-snug">
                    {item.text}
                  </p>
                </div>
              ))}
        ...
        <div className="text-center">
          <div className="inline-flex items-center gap-2 md:gap-3 px-4 py-2 md:px-6 md:py-3 rounded-full bg-white border border-gray-200 shadow-sm">
