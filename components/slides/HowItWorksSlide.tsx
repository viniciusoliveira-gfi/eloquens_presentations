    ...
    <SlideWrapper isActive={isActive} variant="soft">
      <div className="w-full max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-6">
          {steps.map((step, i) => (
            <div key={i} className="clean-card p-3 md:p-6 text-center relative">
              ...
              <div className="icon-box !w-9 !h-9 md:!w-12 md:!h-12 !rounded-xl mx-auto mb-2 md:mb-4">
        ...
        <div className="text-center mt-4 md:mt-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 md:px-5 md:py-3 rounded-full bg-white border border-blue-200 text-brand-accent font-semibold text-xs md:text-sm shadow-sm">
